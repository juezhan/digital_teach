...
//        搜索框
        inputs: [
          ...
          {
            'title': '类型', 'type': 'select', 'itemName': 'userType',
            'options': [
              {'value': '1', 'text': 'A'},
              {'value': '2', 'text': 'B'},
              {'value': '3', 'text': 'C'}
          ...
          {
            'title': '活动性质', 'type': 'checkboxGroup', 'itemName': 'type',
            'options': [
          ...
          {
            'title': '特殊资源', 'type': 'radioGroup', 'itemName': 'resource',
            'options': [
              {'value': '1', 'text': '线上品牌商赞助'},
              {'value': '2', 'text': '线下场地免费'},
            ]
          },
          {'title': '活动形式', 'type': 'textarea', 'itemName': 'desc'},
